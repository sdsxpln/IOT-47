...
uint16_t semaphore_request(uint8_t task_id);

void semaphore_post(uint8_t task_id, uint16_t semaphore);

void flag_create(uint8_t val);

void flag_post();

void flag_request();

uint8_t queue_size(uint8_t task_id);
